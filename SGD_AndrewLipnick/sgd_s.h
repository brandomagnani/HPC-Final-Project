...
void SGD_s(long n,              // number of columns of A
   ...
   for (long t=0; t<T; t++){   // do T iterations of SGD step
       ...
       #pragma omp parallel num_threads(num_of_threads) firstprivate(I,x,gradi) shared(n,d,A,b) //reduction(vec_float_plus:x_new)
         {
